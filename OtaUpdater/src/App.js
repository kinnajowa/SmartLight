...
function CheckVersion(){
  ...
  .then(_ => fetch('https://raw.githubusercontent.com/kinnajowa/SmartLight/master/version.json'))
    ...
    Popup.create({
      ...
      buttons: {
          left: [{
              text: 'Yes',
              action: function () {
                  fetch('https://raw.githubusercontent.com/kinnajowa/SmartLight/master/binaries/' + latestCompatibleSoftware + '/' + currentHardwareVersion + '.bin')
                .then(function (response) {
